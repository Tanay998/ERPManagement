...
<body>
    <div class="container py-4">
        <div class="form-container">
            ...
            <form action="otrinfo3.php" name="form" id="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-section">
                        ...
                        <div class="col-md-12">
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    const input = document.getElementById('dateadd');
                                    const now = new Date();
                                    ...
                                    const defaultValue = `${startYear}-${endYear.toString().slice(-2)}`;
                    ...
                    <div class="row mb-3" id="tfw1" style="display:none;">
                        <div class="col-md-12">
                            <label for="tfw" class="form-label">TFW</label>
                            <select name="tfw" id="tfw" class="form-select" onchange="showt();">
                                <option selected>Select Type of TFW</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                            <input type="hidden" name="tfw1" id="tfw1" value="" />
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="firstname" class="form-control" placeholder="Enter First Name" id="firstname" style="text-transform: uppercase;" />
                        </div>
                        <div class="col-md-4">
                            <label for="middlename" class="form-label">Middle Name</label>
                            <input type="text" name="middlename" class="form-control" placeholder="Enter Middle Name" id="middlename" style="text-transform: uppercase;" />
                        </div>
                        <div class="col-md-4">
                            <label for="lastname" class="form-label">Last Name</label>
                            <input type="text" name="lastname" class="form-control" placeholder="Enter Last Name" id="lastname" style="text-transform: uppercase;" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Father Name" name="fathername" id="fathername" style="text-transform:uppercase;" />
                        </div>
                        <div class="col-md-6">
                ...
                <div class="form-section">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="cstate1" id="cstate1" value="" />
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="ccdistrict" id="ccdistrict" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="pstate1" id="pstate1" value="" />
                        </div>
                        <div class="col-md-6">
                            <label for="pdistrict">District</label>
                            <select class="form-select" id="pdistrict" name="pdistrict" onchange="document.getElementById('ppdistrict').value=this.options[this.selectedIndex].text">
                                <option value="">Select District</option>
                            </select>
                            <input type="text" class="form-control mt-2" id="pdistrict1" name="pdistrict1" style="display:none;" readonly>
                            <input type="hidden" name="ppdistrict" id="ppdistrict">
                        </div>
                    </div>
                ...
                <div class="form-section">
                    <div class="section-title">शैक्षिक योग्यता (EDUCATIONAL QUALIFICATIONS)</div>
                    
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="edu" class="form-label">Education Qualification</label>
                ...
                <div class="form-section">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="profilepic" class="form-label">प्रोफाइल पिक्चर (Profile Picture)</label>
                            <input type="file" name="file" accept="image/*" id="file" class="form-control" onchange="loadFile(event);" />
                            <br />
                            <div class="text-center">
                                <img id="output" name="output" width="150px" height="150px" class="img-thumbnail" />
                            </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="total-fixed" 
                                    name="total_fixed" value="36,000" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Total Payable Amount:</label>
                                <input type="text" class="form-control" id="total-paid" 
                                    name="total_paid" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
